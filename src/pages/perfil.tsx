        ...
        <div className="bg-white rounded-[2.5rem] p-6 sm:p-8 shadow-sm">
          ...
          <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
            ...
            <div>
              ...
              <input type="text" defaultValue="Laisa Mireli de Oliveira Vidal" className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 outline-none focus:border-brand-orange transition-colors" />
            </div>
            ...
            <div>
              ...
              <input type="email" defaultValue="laisa@petcare.com.br" className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 outline-none focus:border-brand-orange transition-colors" />
            </div>
            ...
            <div>
              ...
              <input type="tel" defaultValue="(88) 99999-9999" className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 outline-none focus:border-brand-orange transition-colors" />
            </div>
            ...
            <div>
              ...
              <input type="text" defaultValue="Sobral, CE" className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 outline-none focus:border-brand-orange transition-colors" />
            </div>
